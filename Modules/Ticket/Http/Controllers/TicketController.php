...
use Modules\Ticket\Entities\InfixDepartment;
...
class TicketController extends Controller
{
    ...
    {
        try {
            $user_agent = \App\User::where('role_id','!=', 4)->where('role_id','!=', 5)->where('role_id','!=', 3)->get();
            $category = InfixTicketCategory::latest()->get();
            $priority = InfixTicketPriority::latest()->get();
            $user = \App\User::where('role_id', 5)->get();
            $authors = \App\User::where('role_id', 4)->get();
