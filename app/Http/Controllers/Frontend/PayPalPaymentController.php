        ...
        if ($request->input('paymentId') && $request->input('PayerID'))
        {
            ...
            if ($response->isSuccessful())
            {
                ...
                if(!$isPaymentExist)
                {
                    ...
                    if ($arr_body['transactions'][0]['amount']['total'] >= session()->get('paypal_payable_amount')) {  
                        ...
                        Toastr::error('Please payment minimum  your item price $'.session()->get('paypal_payable_amount'));
                        return redirect()->back();
                    }  
                    //End DM PayPal
                }
