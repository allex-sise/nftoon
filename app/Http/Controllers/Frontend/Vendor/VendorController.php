    ...
    function vendor($data = null)
    {
        try {
           ...
           // $data['category'] =  ItemCategory::where('active_status', 1)->take(6)->get();
            ...
            $data['item'] = Item::where('user_id', $data['user']->id)->where('active_status', 1)->latest()->get();
            ...
            $data['itemspecial'] =  Item::where('user_id', $data['user']->id)->latest()->get();
