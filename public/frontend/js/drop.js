                  ...
                  if (e.C_total!=null) {
                    ...
                    <div class="single-goods">
                        ...
                        <div class="good-title">
                            <h3><a href="${url+'/item/'+e.title.split(" ").join("-").toLowerCase()+'/'+e.id}">${ e.title.substring(0, 30)} ...</a></h3>
                            <p>@<a href="${url+'/user/profile/'+e.username}">${ e.username}</a></p>
                        </div>
                    </div>
    ...
    $(document).ready(function(){ */
       ...
       $("#price_submit").click((e)=>{
        ...
        function AllData(all='', bestsell = '' , newest = '', bestrated='',trending='',high ='',low=''){
           ...
           // $(".databox").empty();      
            $.ajax({
                url: url+'/category?newest='+newest+'&all='+all+'&star='+star+'&NoSell='+NoSell+'&LowSell='+LowSell+'&MediumSell='+MediumSell+'&HighSell='+HighSell+'&TopSell='+TopSell+'&bestrated='+bestrated+'&bestsell='+bestsell+'&trending='+trending+'&high='+high+'&low='+low+'&_categor_id='+_categor_id+'&_subcategor_id='+_subcategor_id+'&key='+key+'&min_price='+min_price+'&max_price='+max_price+'&page='+page+'&_drop_id='+_drop_id,
                method: 'GET',
                success:function(data){
                     //console.log(data);
