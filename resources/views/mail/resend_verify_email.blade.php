                ...
                <table style="border: 1px solid #f1f1f1; border-collapse: collapse;" border="0" max-width="600" align="center" bgcolor="#fff">
                    <tbody >
                        ...
                        <tr>
                            ...
                            <b>Salutare, {{@$data['username'] }} </b>
                                <br />
                                <p>
                                   Bine ai venit pe {{str_replace('_', ' ',config('app.name') ) }}
                                    <br />
                                    Confirma adresa de email apasand pe butonul de mai jos:
                                </p>
                            </td>
                        </tr>
                        <td align="center">
                        ...
                        " href="{{ @$data['reset_url'] }}">Confirm Adresa de email</a>
                            <!-- <a href="">
                        ...
                        <tr style="font-family: 'Quicksand', sans-serif;">
                            ...
                            Daca nu ai facut aceasta solicitare, te rugam sa nu confirmi inregistrarea!
                            </td>
                        </tr>
                    </tbody>
                </table>
