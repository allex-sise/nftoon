...
<section class="sms-breadcrumb mb-40 white-box">
    <div class="container-fluid">
        <div class="row justify-content-between">
            <h1>Detalii Colectie</h1>
            <div class="bc-pages">
                <a href="{{url('admin/dashboard')}}">@lang('lang.dashboard')</a>
                <a href="{{ route('admin.adCollection')}}" class="active">Detalii Colectie</a>
                @if(isset($data['edit']) && !empty(@$data['edit']))
                <a href="#" class="active">Colectie</a>
            @endif
            </div>
        </div>
    </div>
        ...
        <div class="row">
            ...
            <div class="col-lg-9">
                <div class="row">
                    <div class="col-lg-4 no-gutters">
                        <div class="main-title sm_mb_20 lm_mb_35">
                            <h3 class="mb-0">Adauga NFT-uri la Colectia {{$data['edit']->name}} </h3>
                        </div>
                    </div>
                </div>
                <div class="row" style="padding: 15px;">
                    <div class="col-lg-12 no-gutters bg-white" style="padding: 0px 15px 15px 15px;">
                        <div class="main-title sm_mb_20 lm_mb_35">
                            ...
                            <form action="{{url('admin/add-collection-nftstore')}}" method="POST" class="form-horizontal" id="addDrop">
                            @csrf
                            <input type="hidden" name="collection_id" value="{{$data['edit']->id}}">
                            <div class="row mt-25">
                                    <div class="col-lg-12">
                                        <div class="input-effect">
                ...
                <div class="row">
                    <div class="col-lg-4 no-gutters">
                        <div class="main-title sm_mb_20 lm_mb_35">
                            <h3 class="mb-0">@lang('lang.list') NFT-uri din Colectie</h3>
                        </div>
                    </div>
                </div>
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <div class="mt-40 d-flex justify-content-between">
                                                    <button type="button" class="primary-btn tr-bg" data-dismiss="modal">@lang('lang.cancel')</button>
                                                      <a href="{{ route('admin.deleteCollection',@$item->id)}}" class="text-light">
