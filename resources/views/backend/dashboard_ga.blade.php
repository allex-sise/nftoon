      ...
      <a href="#" class="d-block">
        <div class="white-box single-summery">
          <div class="d-flex justify-content-between">
            <div>
              <h3>@lang('lang.users') Activi</h3>
              <p class="mb-0">@lang('lang.total') @lang('lang.users') Activi</p>
            </div>
    ...
    <div class="col-lg-3 col-md-6 mt-30-md">
      <a href="#" class="d-block">
        <div class="white-box single-summery">
          <div class="d-flex justify-content-between">
            <div>
              <h3>@lang('lang.users') Blocati</h3>
              <p class="mb-0">@lang('lang.total') @lang('lang.users') Blocati</p>
            </div>
    ...
    <div class="col-lg-3 col-md-6 mt-30-md">
      <a href="#" class="d-block">
        <div class="white-box single-summery">
          <div class="d-flex justify-content-between">
            <div>
              <h3>NFT-uri Active</h3>
              <p class="mb-0">@lang('lang.total') NFT-uri Active</p>
            </div>
        ...
        <div class="white-box single-summery">
          <div class="d-flex justify-content-between">
            <div>
              ...
              <p class="mb-0">@lang('lang.total') In Asteptarea Aprobarii</p>
            </div>
    ...
    <div class="col-lg-3 col-md-6 mt-30-md">
      <a href="#" class="d-block">
        <div class="white-box single-summery">
          <div class="d-flex justify-content-between">
            <div>
              <h3>NFT-uri @lang('lang.pending')</h3>
              <p class="mb-0">@lang('lang.total') NFT-uri @lang('lang.pending')</p>
            </div>
    ...
    <div class="col-lg-3 col-md-6 mt-30-md">
        <a href="#" class="d-block">
          <div class="white-box single-summery">
            <div class="d-flex justify-content-between">
              <div>
                <h3>@lang('lang.total') NFT-uri</h3>
                <p class="mb-0">@lang('lang.total') NFT-uri  </p>
              </div>
    ...
    <div class="col-lg-3 col-md-6 mt-30-md">
      <a href="#" class="d-block">
        <div class="white-box single-summery">
          <div class="d-flex justify-content-between">
            <div>
              <h3>@lang('lang.total') Vanzari NFT-uri</h3>
              <p class="mb-0">@lang('lang.total') Vanzari  </p>
            </div>
    ...
    <div class="col-lg-4 col-md-6 mt-30-md">
      <a href="#" class="d-block">
        <div class="white-box single-summery">
          <div class="d-flex justify-content-between">
            <div>
              <h3>@lang('lang.total') Suma NFT-uri</h3>
              <p class="mb-0">@lang('lang.total') Suma  </p>
            </div>
