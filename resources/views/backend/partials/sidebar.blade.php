    ...
    <ul class="list-unstyled components">
            ...
            <li>
                ...
                <ul class="collapse list-unstyled" id="subMenuUser">
                    ...
                    @if(Auth::user()->role_id == 1 || in_array(2, $permitted_modules))
                    <li>
                        <a href="{{ route('admin.userLog') }}" class="action-url"> @lang('lang.list') @lang('lang.log') @lang('lang.user') </a>
                    </li>
                    @endif
             {{--      @if(Auth::user()->role_id == 1 || in_array(2, $permitted_modules))
                    <li>
                        <a href="{{ route('admin.registrationBonus') }}" class="action-url">@lang('lang.bonus') @lang('lang.registration') </a>
                    </li>
                    @endif --}}
            ...
            <li>
                ...
                <ul class="collapse list-unstyled" id="subMenuHuman">
                    ...
                    @if(Auth::user()->role_id == 1 || @$data->permission == 1)
                    <li>
                      <a href="{{ route('admin.user_list') }}">@lang('lang.list') @lang('lang.user')</a>
                    </li>
                    @endif
            ...
            @if(Auth::user()->role_id == 1 || in_array(5, $permitted_modules))
                ...
                <ul class="collapse list-unstyled" id="subMenuItem">
                    ...
                    @if(Auth::user()->role_id == 1 || in_array(5, $permitted_modules))
                    <li>
                      <a href="{{ route('admin.adCategory') }}">Categorii</a>
                    </li>
                    @endif
                    <!-- @if(Auth::user()->role_id == 1 || in_array(5, $permitted_modules))
                    <li>
                        <a href="{{ route('admin.subCategory') }}"> Sub Categorii </a>
                    </li>
                    @endif -->
                    @if(Auth::user()->role_id == 1 || in_array(5, $permitted_modules))
                    <li>
                    ...
                    {{-- @if(Auth::user()->role_id == 1 || @$data->permission == 1)
                    <li>
                        <a href="{{ route('admin.ProductSetting') }}">Setari NFT-uri</a>
                    </li>
                    @endif --}}
                </ul>
            </li>
            ...
            <li>
                ...
                <ul class="collapse list-unstyled" id="ItemOrder">
                    @if(Auth::user()->role_id == 1 || in_array(8, $permitted_modules))
                    <li>
                      <a href="{{ route('admin.item_order') }}">Comenzi NFT-uri</a>
                    </li>
                    @endif
                </ul>
            </li>
         ...
         <!--   <li>
            ...
            @if(Module::has('Blog'))
                ...
                <ul class="collapse list-unstyled" id="b">
                    ...
                    <li>
                        <a href="{{ route('blogList') }}">@lang('lang.list') @lang('lang.blog') </a>
                    </li>                   
                </ul>
            </li>
            @endif
