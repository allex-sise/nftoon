                ...
                <div class="col-xl-10 offset-xl-1">
                    <div class="banner-info mb-30 d-flex justify-content-between align-items-center">
                        <div class="profile_author d-flex align-items-center">
                            <div class="thumb">
                                <img style="border-radius: 50%; border: 5px solid #FFF;" src="{{ @$data['user']->profile->image? asset(@$data['user']->profile->image):asset('public/frontend/img/profile/1.png') }}" width="100" alt="">
                               
                            </div>
                            <h5 class="h5spec">{{  @$data['user']->full_name }}</h5>
                                    <a href="{{ route('user.portfolio',@$data['user']->username)}}"><h1 class="h1spec"><span>@</span>{{  @$data['user']->username }}</h1></a>
                                    ...
                                    <div class="tab-content" id="myTabContent">
                                        ...
                                        <div class="tab-pane fade {{ @$data['portfolio'] == url()->current() ?'show active':'' }} " id="profile" role="tabpanel"
                                            ...
                                            <div class="latest-goods-area gray-bg section-padding1" onscroll="OnScroll()">
                                                ...
                                                <div class="col-xl-4 col-md-6 grid-item cat1 cat1 float-left">
                                                    <div class="single-goods">
                                                        ...
                                                        <div class="good-title">
                                                            ...
                                                            <p>@<a href="{{ route('user.portfolio',@$item->user->username)}}">{{ @$item->user->username}}</a></p>
                                                        </div>
                                                    </div>
                                                        <div class="good-info good-info2">
                                                            <div class="good-title good-title2">
                                                                <h3 class="h3clss">Current Price</h3>
                                                                <h3>{{@$infix_general_settings->currency_symbol}}{{ @$item->Reg_total}}</h3>
                                                            </div>
                                                            <div class="good-title good-title2">
                                                ...
                                                <!-- <div class="single_portfolio_list  d-flex align-items-center justify-content-between">
