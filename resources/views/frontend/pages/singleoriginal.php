                              ...
                              <div class="light-lisence-wrap">
                                 <div class="light-pakage-list">
                                    ...
                                    <ul id="license_list">
                                       ...
                                       @if ($data['item']->C_item >=1)
                                           
                                       <li>
                                          <div class="row">
                                             <div class="col-lg-2">
                                                <input type="hidden" id="normal_commercial_price" value="{{ @$data['item']->C_total}}">
                                                <input type="radio" class="price_option" data-default_price="{{ @$data['item']->C_total}}" data-type="commercial_license_price" data-normal="normal_commercial_price" data-support_fee="{{@$data['fees']->support_fee/100*@$data['item']->C_total }}"  name="list_item_price" value="{{ @$data['item']->C_total}}">
                                             </div>
                                       ...
                                       <li>
                                          <div class="row">
                                             <div class="col-lg-2">
                                                ...
                                                <input type="radio" class="price_option" data-default_price="{{ @$data['item']->Ex_total}}" data-type="extended_license_price" data-normal="normal_extended_price" data-support_fee="{{@$data['fees']->support_fee/100*@$data['item']->Ex_total }}"  name="list_item_price" value="{{@$data['item']->Ex_total}}">
                                             </div>
                               ...
                               @php
                                 ...
                                 <div class="lisence-extend d-flex justify-content-between align-items-center">
                                    <div class="lisence-extend-prise d-flex">
                                       <input type="checkbox" id="SupportAdd" name="support_Fee" value="{{@$data['fees']->support_fee/100*@$data['item']->Reg_total }}">
