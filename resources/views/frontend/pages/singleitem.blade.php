                     ...
                     <div class="profile-linking">
                        <div class="profile-name">
                           <div class="theme-logo">
                              <img src="{{ @$data['item']->og->profile->image? asset(@$data['item']->og->profile->image):asset('public/frontend/img/profile/1.png') }}" alt="">
                           </div>
                           <div class="theme-info">
                                 <a href="{{ route('user.portfolio',@$data['item']->og->username)}}"><h4 class="h4c" style="margin-top: 5px;"><span>@</span>{{ @$data['item']->og->username}}</h4> </a>
                           </div>
                        </div>
                     </div>
                  </div>
                   ...
                   @endif
                     ...
                     <div class="single-info-inner userbg2">
                        <div class="single-info-title single-info-column">
                           ...
                           <span class="spansvg2">Creat de <a href="{{ route('user.portfolio',@$data['item']->og->username)}}"><span>@</span>{{ @$data['item']->og->username }} </a>
               ...
               <div class="theme-side-bar mt-20 theme-side-bar2">
                  <div class="profile-linking">
                     <div class="profile-name">
                        ...
                        <div class="theme-info">
                           <h1 class="h1author" style="margin-bottom: 0px; margin-top: 15px;">{{ @$data['item']->og->full_name}}</h1>
                           <h3><span>@</span>{{ @$data['item']->og->username}}</h3>
                           </a>
                        </div>
                     </div>
                  </div>
                  ...
                  <div class="profile-linking">
                     ...
                     <div class="icons">
                        ...
                        <div class="theme-info text3randuri">
                           ...
                           <h6> {!! @$data['item']->og->profile->about !!} </h6>
                        </div>
                     </div>
                  </div>
               </div>
